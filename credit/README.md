...
| Заявка принята в обработку | Сервер вернул 202 Accepted | Ответ сервера | Отображается сообщение «Заявка принята в обработку» и кнопка «Посмотреть статус заявки» |
...
- Пользователь видит сообщение "Заявка принята в обработку".
